...
public class ClimbPIDWithManual extends SequentialCommandGroup {
  /** Creates a new ClimbWithManual. */
  public ClimbPIDWithManual(Elevator elevator, AmpTrap ampTrap, Intake intake, Tilt tilt, Cartridge cartridge) {

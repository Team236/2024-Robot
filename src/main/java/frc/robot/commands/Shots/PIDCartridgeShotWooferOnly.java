...
public class PIDCartridgeShotWooferOnly extends ParallelCommandGroup {
  ...
  public PIDCartridgeShotWooferOnly(Intake intake, Cartridge cartridge, Tilt tilt, double intSpeed, double cartSpeedLeft, double cartSpeedRight, double desiredRevs) {
      addCommands(

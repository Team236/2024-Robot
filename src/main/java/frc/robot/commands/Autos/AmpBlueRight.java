...
public class AmpBlueRight extends SequentialCommandGroup {

  public AmpBlueRight(Intake intake, Cartridge cartridge, AmpTrap ampTrap, Tilt tilt, Drive drive, Elevator elevator) {
    ...
    new PIDTurnCCW(drive, 90).withTimeout(1.5), //+3

...
public class L_WooferShotPullOut extends ParallelCommandGroup {
  /** Creates a new OneWooferShot. */
  public L_WooferShotPullOut(Intake intake, Cartridge cartridge, Tilt tilt, Drive drive, Elevator elevator) {
    addCommands(

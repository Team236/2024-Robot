...
private Robot robot;
  ...
  public SpeakerShotFromWoofer(CartridgeShooter cartridgeShooter, Robot robot) {
  ...
  public void end(boolean interrupted) {
     ...
     //robot.counter.reset();  //try this after implementing TrapAmpShooter branch changes;
  }

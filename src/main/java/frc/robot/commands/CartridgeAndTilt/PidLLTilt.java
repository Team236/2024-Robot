...
//Limelight stuff:
  ...
  private double dxRight, dzForward, tagDistance; //horizontal distance from AprilTag (target) to LL camera lens
  ...
  public void execute() {
    ...
    */
        dxRight = Units.metersToInches( targetCameraPose[0] );  
        dzForward = Units.metersToInches( targetCameraPose[1] );
        // z= sqrt(x^2 + y^2)
        tagDistance = Math.sqrt((dxRight * dxRight) + (dzForward * dzForward));
 ...
 if (bumperOffset < 45.9) {   //old Dx < 3
      desiredRevs = -19;// -17;  //TODO get actual desiredRevs numbers
        } else if  ((dxRight >= 45.9) && (dxRight < 50))  {  //old Dx between 3 and 6
      desiredRevs = -21;//-23.6;
    } else if  ((dxRight >= 50) && (dxRight < 56.6))  { //old Dx between 6 and 12
      desiredRevs = -22.6;// -23.6;
    } else if  ((dxRight >= 56.6) && (dxRight < 62.2))  { //old Dx between 12 and 18
      desiredRevs = -30;//-27.8;
    } else if  ((dxRight >= 62.2) && (dxRight < 69))  { //old Dx between 18 and 24
      desiredRevs = -35;//-30;
    } else if  ((dxRight >= 69) && (dxRight < 71.85))  { //old Dx between 24 and 30
      desiredRevs = -39;//-32.5;
    } else if  ((dxRight >= 71.85) && (dxRight < 76.6))  { //old Dx between 30 and 36
      desiredRevs = -42.3;// -36.85;
    } else if  ((dxRight >= 76.6) && (dxRight < 78.3))  { //old Dx between 36 and 39
      desiredRevs = -43.6;//-38.2;
    } else if  ((dxRight >= 78.3) && (dxRight < 80))  { //old Dx between 39 and 42
      desiredRevs = -45;//-39.42;
    } else if  ((dxRight >= 80) && (dxRight < 81.9))  { //old Dx between 42 and 45
      desiredRevs = -46;// -41.26;
    } else if ((dxRight >= 81.9) && (dxRight < 82.9)) { //old Dx between 45 and 48
      desiredRevs = -46.8;//-44;
    } else if ((dxRight >= 82.9) && (dxRight < 85.8)) {  //old Dx between 48 and 52 - MEASURE ENC VALUE HERE
      desiredRevs =  -47.2;//-45;  //THIS NEEDS TO BE MEASURED!
    } else if ((dxRight >= 85.8) && (dxRight < 86.9)) { //Old Dx between 52 and 55- MEASURE ENC VALUE HERE

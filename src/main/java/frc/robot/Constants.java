...
public final class Constants {
  ...
  public static class Elevator {
    ...
    public static final double MATCH_HEIGHT= 4;//set to zero for testing without cycling on/off
    public static final double MIN_HEIGHT = 1 - MATCH_HEIGHT;
    public static final double MAX_HEIGHT = 27 - MATCH_HEIGHT;
    public static final double JUST_ABOVE_CHAIN_HEIGHT = 22.8 - MATCH_HEIGHT;
    public static final double CLIMB_HEIGHT = 1 - MATCH_HEIGHT;
